...
void ofApp::setup(){
    ...
    */
    ...
    // imagen a componer
    pepperMosaico.loadImage("/home/natxo/SocialPrinterTwiiter/WebPanelPublic/uploads/"+screen_file);
    //pepperMosaicoToPrint.loadImage(print_file);
    
    //
    tweetStream.setImageDestinoMosaico(&pepperMosaico, "/home/natxo/SocialPrinterTwiiter/WebPanelPublic/uploads/"+print_file);
